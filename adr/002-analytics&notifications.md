...
* Опции:
1. Синхронный REST/gRPC (Request/Response)  
...
2. Асинхронный обмен сообщениями (Event-Driven через Message Broker)  
...
* Принятое решение:  
​Использовать асинхронный Event-Driven подход с брокером сообщений (Apache Kafka).  
* ​Обоснование:
